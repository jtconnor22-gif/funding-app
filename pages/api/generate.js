...
const DESIGN_SYSTEM = `
You MUST output a complete, self-contained HTML document. Do not output markdown. Do not output plain text. Do not wrap your response in code fences. Start with <!DOCTYPE html> and end with </html>. Nothing before, nothing after.
